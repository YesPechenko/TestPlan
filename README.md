...
2. Заполнить поле телефон: +79546465446
3. Устанавить чекбокс "Я согласен(а) на обработку персональных данных"
4. Нажать кнопку "Мы перезвоним"

**Ожидаем:** появляется сообщение "Спасибо, скоро мы вам перезвоним!"

1. Заполнить поле имя: Иван-Иван 
2. Заполнить поле телефон: 89546465446
3. Установить чекбокс "Я согласен(а) на обработку персональных данных"
4. Нажать кнопку "Мы перезвоним"

**Ожидаем:** появляется сообщение "Спасибо, скоро мы вам перезвоним!"

1. Заполнить поле имя: Иванов Иван Иванович
2. Заполнить поле телефон: 9546465446
3. Установить чекбокс "Я согласен(а) на обработку персональных данных"
4. Нажать кнопку "Мы перезвоним"

**Ожидаем:** появляется сообщение "Спасибо, скоро мы вам перезвоним!"

1. Заполнить поле имя: (пробел) Иван (пробел)
2. Заполнить поле телефон: +79546465446
3. Установить чекбокс "Я согласен(а) на обработку персональных данных"
4. Нажать кнопку "Мы перезвоним"
...
1. Заполнить поле имя: Иван
2. Заполнить поле телефон: 13546
3. Установить чекбокс "Я согласен(а) на обработку персональных данных"
4. Нажать кнопку "Мы перезвоним"
...
1. Заполнить поле имя: пустое поле
2. Заполнить поле телефон: пустое поле
3. Установить чекбокс "Я согласен(а) на обработку персональных данных"
4. Нажать кнопку "Мы перезвоним"

**Ожидаем:** появляется сообщение "Поля не заполнены""

1. Заполнить поле имя: И
2. Заполнить поле телефон: пустое поле
3. Установить чекбокс "Я согласен(а) на обработку персональных данных"
4. Нажать кнопку "Мы перезвоним"
...
1. Заполнить поле имя: Иван... (больше 64 значение)
2. Заполнить поле телефон: +795464654466 (больше 11 значений)
3. Установить чекбокс "Я согласен(а) на обработку персональных данных"
4. Нажать кнопку "Мы перезвоним"
